...
import jqueryi18n from '../../libs/jquery-i18next';
import $ from 'jquery';
import jstree from '../../libs/jstree';
...
export class Viewer extends EventDispatcher{
	...
	setPointBudget (value) {
		if (PotreeExports.pointBudget !== value) {
			PotreeExports.pointBudget = parseInt(value);
			this.dispatchEvent({'type': 'point_budget_changed', 'viewer': this});
		}
	};

	getPointBudget () {
		return PotreeExports.pointBudget;
	};
	...
	update(delta, timestamp){
		...
		PotreeExports.pointLoadLimit = PotreeExports.pointBudget * 2;
